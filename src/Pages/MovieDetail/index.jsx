                    ...
                    <div className={cx('cover')}>
                        <div className={cx('wrapper')}>
                            <div className={cx('col l-3 m-r-24 m-l-48 m-b-24')}>
                                <img
                                    src={`https://www.themoviedb.org/t/p/w220_and_h330_face/${movie.poster_path}`}></img>
                            </div>
                            <div className={cx('col m-6', 'flex-1')}>
                                ...
                                <div>
                                    <button className={cx('certification')}>TV-14</button>
                                ...
                                <div className={cx('actions', 'm-t-24 m-b-24')}>
                                    <button className={cx('btn', 'percent')}>77%</button>
                                ...
                                <h4 className={cx('tagline')}>{movie.tagline}</h4>
                                <div className={cx('overview', 'm-t-24 m-b-48')}>
                                    <h3>Overview</h3>
                                    <p>{movie.overview}</p>
                                </div>
                                <div className={cx('row no-gutters')}>
                                    {movie.created_by &&
                                        movie.created_by.map((item, index) => (
                                            <div key={index} className={cx('m-l-48')}>
                                                <h3>{item.name}</h3>
                                                <p>Creator</p>
                                            </div>
                                        ))}
                    ...
                    <div className={cx('row no-gutters space-bw m-t-24')}>
                        ...
                        <div className={cx('l-2 m-t-24 m-l-24', 'contact')}>
                            <a href="" className={cx('link-social')}>
                                <FontAwesomeIcon className={cx('ic-social')} icon={faFacebook} />
                            </a>
                            <a href="" className={cx('link-social')}>
                                <FontAwesomeIcon className={cx('ic-social')} icon={faTwitter} />
                            </a>
                            <a href="" className={cx('link-social')}>
                                <FontAwesomeIcon className={cx('ic-social')} icon={faInstagram} />
                            </a>
                            <a href="" className={cx('link-heart')}>
                                <FontAwesomeIcon className={cx('ic-social')} icon={faHeart} />
                            </a>
